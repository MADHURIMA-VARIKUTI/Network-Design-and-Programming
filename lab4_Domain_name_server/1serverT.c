...
int main()
{
	...
	strcpy(stu[0].student_id,"210953314");
	strcpy(stu[1].student_id,"210953334");
	...
	strcpy(stu[0].fname,"MADHU");
	strcpy(stu[1].fname,"MAHA");
	strcpy(stu[0].lname,"RIMA");
	strcpy(stu[1].lname,"THI");
...
/*nput the Port Number: 1245

Socket created.
Socket binded.
Socket listening.
Socket accepting.Socket accepting.Socket accepting.Socket accepting.Socket accepting.Socket accepting.Socket accepting.Socket accepting.Socket accepting.s
*/
